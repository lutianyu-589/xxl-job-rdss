				                ...
				                <thead>
					            	<tr>
                                        ...
                                        <th name="executorParam" >${I18n.jobinfo_field_executorparam}</th>
					                  	...
					                  	<th name="alarmContacts" >${I18n.jobinfo_field_alarmcontacts}</th>
			...
			<div class="modal-header">
         	...
         	<div class="modal-body">
				<form class="form-horizontal form" role="form" >
                    ...
                    <div class="form-group">
                        <label for="lastname" class="col-sm-2 control-label">${I18n.jobinfo_field_alarmcontacts}<font color="black">*</font></label>
                        <div class="col-sm-8"><input type="text" class="form-control" name="alarmContacts" placeholder="${I18n.jobinfo_field_alarmcontacts_placeholder}" maxlength="200" ></div>
                    </div>
                    <br>
